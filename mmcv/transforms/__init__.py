...
from .loading import LoadAnnotations, LoadImageFromFile, LoadImageFromFileMine
from .processing import (CenterCrop, MultiScaleFlipAug, Normalize, Pad,
                         RandomChoiceResize, RandomFlip, RandomGrayscale,
                         RandomResize, Resize, TestTimeAug, ResizeMine)
...
try:
    ...
    __all__ = [
        ...
        'RandomApply', 'TestTimeAug', 'LoadImageFromFileMine', 'ResizeMine'
    ]
else:
    ...
    __all__ = [
        ...
        'LoadImageFromFileMine', 'ResizeMine'
    ]
